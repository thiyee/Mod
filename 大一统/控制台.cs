...
namespace 大一统{
    ...
    public class 大一统控制台UI : SingletonOptions<大一统控制台UI>
    {
        ...
        [Option("叠叠乐", "所有建筑只占用一格实体 模型大小不变", "功能性修改")] [JsonProperty] public bool 叠叠乐 { get; set; }
        ...
        [Option("小人初始技能点", "控制小人在被打印或创建时获取的用于学习技能的技能点", "属性控制")] [Limit(0, 10)] [JsonProperty] public int 小人初始技能点 { get; set; }
