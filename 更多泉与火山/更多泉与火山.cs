...
namespace 更多泉与火山
{
	public class 更多泉与火山
	{
		...
		static string[] TemplateName = new string[]{
				...
				"molten_glass",
				"molten_carbon",
				"geysers/super_coolant",
				"geysers/LiquidPhosphorus",
				"geysers/Petroleum",
				"geysers/molten_sucrose",
				"geysers/molten_niobium",
				"geysers/molten_uranium",
				"geysers/molten_steel",
				"geysers/molten_glass",
				"geysers/molten_carbon",
				};
		...
		public class 增加新的泉2
		{
            ...
            private static void Prefix(ref WorldGen __instance)
			{
				if (__instance.isStartingWorld && !isinit)
				{
					...
					AllowedCellsFilterReflectionHelper.SetPrivateProperties(allowedCellsFilterList[0], TagCommand.DistanceFromTag,"AtStart",2,10,Command.Replace,new List<Temperature.Range>(), new List<SubWorld.ZoneType>(),new List<string>());

					AllowedCellsFilterReflectionHelper.SetPrivateProperties(allowedCellsFilterList[1], TagCommand.Default, "", 0, 0, Command.ExceptWith, new List<Temperature.Range>(), new List<SubWorld.ZoneType> { SubWorld.ZoneType.Space}, new List<string>());
					...
					TemplateSpawnRulesReflectionHelper.SetPrivateProperties(
						templateSpawnRules,
						null,
						new List<string> { "super_coolant", "LiquidPhosphorus", "Petroleum", "molten_sucrose", "molten_niobium", "molten_uranium", "molten_steel", "molten_glass", "molten_carbon" },
						ListRule.TryAll,
						0,
						0,
						1,
		...
		public class 增加新的泉3
		{
			...
			private static bool Prefix( ref TemplateContainer __result, string templatePath){
                ...
                if (!isinit){
					...
					info.area = 16;
					foreach (List<Prefab> prefab in gprefabs1){
					...
					info.area = 20;
					foreach (List<Prefab> prefab in gprefabs2){
				...
				foreach (TemplateContainer t in container){
